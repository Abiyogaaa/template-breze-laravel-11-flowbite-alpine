            ...
            <div class="flex items-center">
                ...
                <a href="#" class="flex items-center group relative">
                    <div class="relative h-10 w-10">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-amber-950 to-gray-950 rounded-xl rotate-2 transform transition-all duration-300 group-hover:rotate-6 group-hover:scale-105">
                        </div>
                        <div
                    ...
                    <span
                        class="ml-3 text-4xl font-bold bg-gradient-to-r from-amber-700 via-amber-950 to-gray-950 bg-clip-text text-transparent hover:from-amber-600 hover:via-amber-400 hover:to-amber-200 transition-all duration-300">
                        KEAN COFFEE
                    </span>
